...
function calcular() {
    ...
    if(suma < 6){
        Swal.fire(
            'EN HORA BUENA!',
            'Aparentemente es poco probable que padezcas intolerancia a la lactosa.',
            'success'
          )
    }
    else if(suma < 9){
        Swal.fire(
            'PRECAUCIÓN!',
            'Tienes una probabilidad moderada que padezcas intolerancia a la lactosa.',
            'info'
          )
    }
    else{
        Swal.fire(
            'ADVERTENCIA!',
            'Tienes una probabilidad alta que padezcas intolerancia a la lactosa.',
            'warning'
          )
    }
